...
function LayoutContent({ children, currentPageName }) {
  ...
  const showLunaHeaderBar = ['/lunatemplate','/blacksmith','/seasonalpass','/entertainment','/clan','/community','/storyline','/worldevents','/aiachievements','/achievements'].some(s => location.pathname.toLowerCase().includes(s));
