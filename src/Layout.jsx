    ...
    <div className="h-screen w-screen text-slate-300 font-sans flex flex-col overflow-hidden relative" style={{ background: 'linear-gradient(135deg, #0f1419 0%, #1a1f2e 25%, #0d1117 50%, #1a1f2e 75%, #0f1419 100%)' }}>
                    ...
                    {showNotificationsHeader && (
                      <>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <a href="https://discord.gg/yZaJh9gwX" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-full text-sm font-medium transition-all backdrop-blur-md border bg-[#5865F2]/20 border-[#5865F2]/30 text-[#5865F2] hover:bg-[#5865F2]/30 hover:text-white flex items-center gap-2">
      ...
      <main className="flex-grow overflow-hidden">
        <div className="page-container">
          <ErrorBoundary>
            <Suspense fallback={<RouteLoadingFallback />}>
              <UniversalPageRail pathname={location.pathname}>{children}</UniversalPageRail>
            </Suspense>
          </ErrorBoundary>
        </div>
      </main>
