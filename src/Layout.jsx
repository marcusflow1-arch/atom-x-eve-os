          ...
          <div className="fixed top-4 left-4 z-40 flex flex-col gap-1.5">
            {headerConfig.showMenu && isEditorMode && (
                                <div className="flex items-center gap-3">
                                  ...
                                  {/* Social Hub Shortcut Button */}
                                  <Link
                                    to={createPageUrl('SocialFeed')}
                                    className="px-4 py-2 rounded-xl bg-white/[0.05] backdrop-blur-2xl hover:bg-white/[0.1] flex items-center gap-2 transition-all shadow-[0_4px_20px_rgba(0,0,0,0.2)] border border-white/10 hover:border-white/20"
                                    style={{ WebkitBackdropFilter: 'blur(40px) saturate(200%)' }}
                                  >
