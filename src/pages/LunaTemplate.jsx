    ...
    >
      ...
      <div className="w-full mt-24 px-12 flex flex-col items-start gap-12">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex gap-4">
            {[1, 2, 3, 4, 5].map(i => (
              <div key={`relic-${i}`} className="w-20 h-20 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] shadow-lg hover:bg-white/[0.05] transition-all duration-300"></div>
            ))}
          </div>
        </div>
