                      ...
                      <motion.div
                        ...
                        <div className="flex flex-col gap-8 flex-shrink-0 py-8 ml-8 relative z-30">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <div className="relative w-52 h-4 mb-4">
                              <div className="absolute top-2 left-0 right-0 h-[1px] bg-white/20"></div>
                          ...
                          <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="relative w-96 h-4"><div className="absolute top-2 left-0 right-0 h-[1px] bg-white/20"></div><div className="absolute top-1 left-1/2 -translate-x-1/2 w-24 h-[1px] bg-white/20"></div><div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full border border-white/40"></div></div>
                          ...
                          <div className="flex items-start justify-between gap-8 w-full">
                            ...
                            <div className="flex flex-col items-center gap-4">
                              ...
                              <div className="relative w-80 h-4"><div className="absolute top-2 left-0 right-0 h-[1px] bg-white/20"></div><div className="absolute top-1 left-1/2 -translate-x-1/2 w-20 h-[1px] bg-white/20"></div><div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full border border-white/40"></div></div>
