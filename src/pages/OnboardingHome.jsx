...
const walkthroughFeatures = [
  {
    ...
    summary: 'The store is the first destination and acts as the main launch surface for discovery, marketplace activity, and featured content.',
    walkthrough: 'Start here to browse featured games, explore marketplace sections, and understand the overall platform flow before diving deeper into any specific system.',
    bullets: ['Featured games', 'Marketplace tabs', 'Main entry point'],
    page: 'Store',
  ...
  },
  {
    icon: LibraryIcon,
    title: 'Game Library',
    summary: 'The library is where players manage their owned games, open details, launch sessions, and move into deeper game-specific tabs.',
    walkthrough: 'Use the left side to choose a game, then use the right panel to review content, community, support, and launch actions for that title.',
    bullets: ['Owned games', 'Detail tabs', 'Launch and stream actions'],
    page: 'Library',
  ...
  },
  {
    ...
    summary: 'The community page helps users find game-specific conversations, post content, and move through active discussions and topic filters.',
    walkthrough: 'First choose a game, then switch topic filters, read the feed, open a post, and create a new post when you want to contribute to that game’s conversation.',
    bullets: ['Game-based forum', 'Topic filters', 'Post and reply flow'],
    page: 'Community',
  ...
  },
  {
    icon: Users,
    title: 'Clan Space',
    summary: 'Clan is the team coordination space for rosters, strongholds, shared game workspaces, and division-level activity.',
    walkthrough: 'Use this page to understand team structure first, then move into clan home, roster, or game chat areas depending on whether you want overview, management, or collaboration.',
    bullets: ['Division home', 'Roster and roles', 'Game workspace handoff'],
    page: 'Clan',
  ...
  },
  {
    ...
    summary: 'Aura is the live streaming discovery layer where users move through streaming content and connected live experiences.',
    walkthrough: 'Open Aura when you want to showcase live content, discover broadcasts, and understand how the platform’s streaming layer connects to the rest of the ecosystem.',
    bullets: ['Live stream discovery', 'Streaming-focused navigation', 'Broadcast layer'],
    page: 'Aura',
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl items-center px-6 py-12 md:px-10 lg:px-16">
        <div className="w-full space-y-10">
            ...
            >
              ...
              <div className="relative mt-8 max-w-3xl">
                ...
                <p className="mt-6 max-w-2xl text-base leading-7 text-white/68 md:text-lg">
                  This welcome page now works as a guided demonstration so users can understand what the main pages do before entering the platform itself.
                </p>
              </div>
              ...
              <div className="relative mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div className="flex items-center gap-5 text-sm text-white/45">
                  <span className="flex items-center gap-2"><Play className="h-4 w-4 text-cyan-300" /> Guided intro</span>
                  <span className="flex items-center gap-2"><Layers className="h-4 w-4 text-violet-300" /> Page-by-page demo</span>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-6 rounded-[24px] border border-white/10 bg-white/[0.04] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
                    ...
                    <div className="mt-5 grid gap-3">
                      {[
                        { icon: Shield, title: 'Clear onboarding', text: 'The welcome page now explains where each main section fits in the experience.' },
                        { icon: ShoppingBag, title: 'Store-first default', text: 'Users land inside the shopping experience immediately.' },
                        { icon: Users, title: 'Demo-driven flow', text: 'New visitors can understand the platform before they start clicking around.' },
                      ].map((item) => {
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[32px] border border-white/12 bg-white/[0.04] p-4 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-[28px] md:p-6"
          >
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02)_25%,rgba(10,15,28,0.2)_60%,rgba(10,15,28,0.35))]" />
