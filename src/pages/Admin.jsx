...
import AttachmentCorrectionLab from '../components/admin/attachmentCorrection/AttachmentCorrectionLab';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="backgrounds" className="space-y-6">
          <TabsList className="bg-slate-900 border border-slate-800">
            ...
            <TabsTrigger value="attachment-correction">Attachment Correction Lab</TabsTrigger>
        ...
        <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 mb-8">
          ...
          <TabsContent value="attachment-correction">
            <AttachmentCorrectionLab />
          </TabsContent>
