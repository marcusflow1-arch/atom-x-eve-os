...
import { Upload, Trash2, Play, Pause, Check, X, Film, Loader2, Gamepad2, RefreshCw, Plus, Search, Bot, Terminal, ChevronRight, Eye, Globe, Copy, Download } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="backgrounds" className="space-y-6">
          <TabsList className="bg-slate-900 border border-slate-800">
            ...
            <TabsTrigger value="models">3D Model Viewer</TabsTrigger>
          </TabsList>
            ...
            <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">
                    Upload, preview, and manage GLTF/GLB 3D model files
                  </p>
                </div>
                <Badge variant="outline" className="text-slate-400">
