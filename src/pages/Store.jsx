        ...
        <div className="h-screen w-full flex relative overflow-hidden text-white font-sans" style={{ background: 'linear-gradient(135deg, #0f1419 0%, #1a1f2e 25%, #0d1117 50%, #1a1f2e 75%, #0f1419 100%)' }}>
          ...
          <div className="flex-1 relative h-full overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              {/* Secondary Store Controls Bar - CENTERED SUB-CATEGORIES ONLY */}
              {storeSubView === 'games' && (
                <div className="fixed top-16 left-[5%] right-0 z-40 flex items-center justify-center px-4 py-2" style={{ background: 'rgba(8, 12, 18, 0.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
