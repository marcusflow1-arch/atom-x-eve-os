...
export default function DepsArt() {
    ...
    return (
        <PageErrorBoundary pageName="DepsArt">
          <WishlistProvider>
            <GlassPageFrame
              topContent={
                <div className="flex items-center justify-between w-full gap-4">
                  <div className="flex items-center gap-6">
                    <span className="text-lg font-bold tracking-wider text-white/90">ATOM×EVE DepsArt</span>
                  ...
                  <div className="flex items-center gap-1.5">
                    <button className="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all border bg-white/15 border-white/25 text-white">DepsArt</button>
                                ...
                                {storeMode === 'library' ? (
                                    ...
                                    viewMode === 'classic' ? (
                                        ...
                                        <motion.div key="cross-interface" className="w-full h-full relative" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                                            {loading ? (
                                                <LoadingState fullScreen message="Loading DepsArt..." />
