...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen w-full overflow-hidden relative bg-[#0f1115]">
      ...
      <div className={`absolute right-8 top-1/2 -translate-y-1/2 w-72 z-30 transition-opacity duration-500 origin-right scale-[0.45] ${currentMode === 'ai' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className={`absolute right-6 bottom-4 z-30 transition-opacity duration-500 origin-bottom-right scale-[0.39] ${currentMode === 'ai' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
          <OctagonSkillTree />
        </div>
