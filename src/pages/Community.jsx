...
import { 
    ...
    Video, Image, Palette, Newspaper, Book, Wheat, BookOpen, ChevronLeft
} from 'lucide-react';
...
export default function CommunityPage() {
    ...
    const [showCreateForm, setShowCreateFormState] = useState(false);
            ...
            <AnimatePresence>
                {showCreateForm && (
                    <PostComposer
                        ...
                        onCancel={() => setShowCreateFormState(false)}
