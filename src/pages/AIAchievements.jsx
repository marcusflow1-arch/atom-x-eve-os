  ...
  return (
    <div className="h-screen w-full text-slate-200 overflow-hidden relative font-sans selection:bg-blue-500/30" style={{ background: 'linear-gradient(135deg, #0f1419 0%, #1a1f2e 25%, #0d1117 50%, #1a1f2e 75%, #0f1419 100%)' }}>
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Game Banner Section - At very top, under header tabs (Home, Clan, Forum, Aura) */}
        <div className="px-6 md:px-8 pt-20 pb-0">
          <LibraryBannerSection games={allGames} navigate={navigate} />
        </div>
        
        {/* Main Layout: 2 Columns */}
        <div className="flex gap-6 flex-1 overflow-hidden px-6 md:px-8 pb-6 md:pb-8">
