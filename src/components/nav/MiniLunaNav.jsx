    ...
    <div className="w-full px-8 py-4">
      <div className="flex items-center justify-start gap-6 flex-wrap">
        <div className="flex items-center gap-6 order-1">
          <button onClick={() => { if (typeof window !== 'undefined') { if (typeof window.openAppDrawer === 'function') { window.openAppDrawer(); } else { window.dispatchEvent(new CustomEvent('openAppDrawer')); } } }} className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md flex items-center justify-center transition-all shadow-lg border border-white/10">
