  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        animate={{
          width: isExpanded || isHovered ? 20 : 12,
          height: isExpanded || isHovered ? 20 : 12,
          opacity: isExpanded || isHovered ? 1 : 0.3,
          x: isExpanded ? 4 : 0,
        }}
        ...
        style={{
          ...
          border: `1px solid ${isExpanded || isHovered ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.1)'}`,
          boxShadow: isExpanded || isHovered ? '0 0 20px rgba(255, 255, 255, 0.1)' : 'none',
        }}
      >
        {/* Inner glow dot */}
        <motion.div
          animate={{
            opacity: isExpanded || isHovered ? 1 : 0.5,
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            transition={{ type: 'spring', damping: 25, stiffness: 300 }}
            className="ml-1 flex items-center overflow-hidden rounded-r-2xl"
            style={{
              ...
              {MENU_ITEMS.map((item, index) => {
                ...
                return (
                  <motion.button
                    ...
                    title={item.label}
                  >
                    <Icon className={`w-5 h-5 transition-colors ${getItemColor(item, isActive)}`} />
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        style={{ backgroundColor: `var(--${item.color}-400, #fff)` }}
                      />
                    )}
                  </motion.button>
                );
