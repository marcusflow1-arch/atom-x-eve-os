...
import {
  ...
  ArrowLeftRight, Star, ChevronRight, ChevronLeft as ChevronLeftIcon
} from 'lucide-react';
    ...
    <div className="h-full flex min-h-0 relative">
      ...
      <button
        onClick={() => {
          ...
          if (!leftCollapsed) { setSelectedGame(null); setSelectedItem(null); setSelectedOffer(null); }
        }}
        ...
        {leftCollapsed ? (
          ...
          <div className="h-full flex flex-col overflow-hidden">
            <div className="px-6 pt-4 pb-2 border-b border-white/6 flex items-center justify-between">
              <h2 className="text-white font-bold text-base">All Games — Trading Post</h2>
              ...
              <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(5, 1fr)' }}>
                {filteredGames.map(game => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    onClick={() => { setLeftCollapsed(false); setSelectedGame(game); setSelectedItem(null); setSelectedOffer(null); }}
