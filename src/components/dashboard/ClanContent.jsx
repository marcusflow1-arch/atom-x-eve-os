...
import { LayoutDashboard, Users, MessageSquareText, Info, Swords, Archive, Activity } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-6 relative z-10">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-6 text-sm text-slate-400 mt-2 font-medium">
                                ...
                                <span className="italic text-slate-500 border-l border-white/10 pl-4">"Forge the future, pixel by pixel."</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-grow flex gap-6 overflow-hidden">
                    ...
                    <div className="w-64 flex-shrink-0 flex flex-col gap-2">
                        <div className="bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 p-2 shadow-lg flex flex-col gap-1 h-full">
                            <div className="px-4 py-3 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Command Center</div>
                            {tabs.map(tab => (
                                <button
                                    key={tab.id}
                            ...
                            <div className="mt-auto p-4 bg-slate-950/50 rounded-xl border border-white/5">
                                <h4 className="text-xs font-bold text-slate-400 uppercase mb-2">Guild Status</h4>
