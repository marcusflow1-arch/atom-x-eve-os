...
import {
  ...
  Play, X, RotateCw, Clock, TrendingUp } from
'lucide-react';
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="bg-clip-text text-transparent mb-2 px-8 text-5xl font-black from-slate-700 via-blue-600 to-slate-700">Season 1: Awakening
