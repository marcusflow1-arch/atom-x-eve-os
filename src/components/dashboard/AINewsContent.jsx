...
import { Clock, TrendingUp, Zap, Users, Search, Eye, Heart, Share2 } from 'lucide-react';
...
export default function AINewsContent() {
    ...
    return (
        <div className="font-sans p-6 text-slate-200">
            <style>{`
                .news-container {
