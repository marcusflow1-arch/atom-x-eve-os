...
export default function LunaDashboardOfflineView() {
  return (
    <motion.div
      ...
      className="absolute inset-0 z-10 flex items-center justify-center pointer-events-auto pt-[100px] pl-[400px] pr-[100px] pb-[100px]"
    >
      {/* AAA liquid glass background just around the UI */}
      <div 
        className="w-full h-full max-w-7xl max-h-[800px] rounded-3xl p-8 grid grid-cols-3 grid-rows-2 gap-6"
        style={{
      ...
      >
        {/* Box 1: Friends News */}
        <div className="col-span-1 row-span-2 rounded-2xl bg-white/5 border border-white/10 p-6 flex flex-col gap-4 overflow-hidden relative group hover:bg-white/10 transition-colors">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3">
            <Users className="w-5 h-5 text-blue-400" />
            <h3 className="text-white font-bold tracking-wider uppercase text-sm">Friends Network</h3>
          </div>
        ...
        {/* Box 2: Latest Games */}
        <div className="col-span-1 row-span-1 rounded-2xl bg-white/5 border border-white/10 p-6 relative overflow-hidden group hover:bg-white/10 transition-colors">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3 mb-4">
            <Gamepad2 className="w-5 h-5 text-cyan-400" />
            <h3 className="text-white font-bold tracking-wider uppercase text-sm">Store Highlights</h3>
          </div>
        ...
        <div className="col-span-1 row-span-1 rounded-2xl bg-gradient-to-br from-emerald-900/30 to-teal-900/10 border border-emerald-500/20 p-6 flex flex-col hover:border-emerald-500/40 transition-colors">
          <div className="flex items-center gap-3 border-b border-emerald-500/20 pb-3 mb-4">
          ...
          <button className="mt-auto w-full py-2.5 bg-emerald-500/20 hover:bg-emerald-500/40 text-emerald-300 font-bold rounded-lg border border-emerald-500/30 transition-all text-sm">
            Start Interaction
          </button>
        </div>

        {/* Box 4: Latest Achievement Cards */}
        <div className="col-span-1 row-span-1 rounded-2xl bg-white/5 border border-white/10 p-6 hover:bg-white/10 transition-colors">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3 mb-4">
          ...
          <div className="flex justify-around items-center h-[90px]">
            {[1, 2, 3].map(i => (
              <div key={i} className="w-16 h-full rounded bg-gradient-to-b from-yellow-500/20 to-orange-500/10 border border-yellow-500/30 flex items-center justify-center shadow-lg hover:scale-105 transition-transform cursor-pointer">
        ...
        {/* Box 5: AI News */}
        <div className="col-span-1 row-span-1 rounded-2xl bg-white/5 border border-white/10 p-6 hover:bg-white/10 transition-colors flex flex-col">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3 mb-4">
