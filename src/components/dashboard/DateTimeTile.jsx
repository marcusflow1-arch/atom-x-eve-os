  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-row items-stretch">
        ...
        {/* Left Side: Calendar */}
        <div className="flex-[1.5] p-3 px-5 flex items-center gap-4 overflow-hidden relative">
        ...
        <motion.div 
          ...
          className="flex-[1] flex flex-col justify-center cursor-pointer group transition-colors relative overflow-hidden p-3 px-5"
        >
          {/* Updates Header */}
