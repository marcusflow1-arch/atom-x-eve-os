...
export default function Hi3DPlayerPreview({ config, interactive = false, portrait = false, controls = "none", idleOnly = controls == "none", onCapabilities, secondaryCharacter = null, initialYaw = 0 }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      }, { portrait, secondaryCharacter, initialYaw });
  ...
  },[retry, portrait, initialYaw, secondaryCharacter?.modelUrl, secondaryCharacter?.animationUrl, secondaryCharacter?.animationName]);
