...
export default function Hi3DPlayerPreview({ config, interactive = false, portrait = false, controls = "none", idleOnly = controls == "none", onCapabilities, secondaryCharacter = null, initialYaw = 0, skillEffects = false }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      }, { portrait, secondaryCharacter, initialYaw, skillEffects });
  ...
  },[retry, portrait, initialYaw, skillEffects, secondaryCharacter?.modelUrl, secondaryCharacter?.animationUrl, secondaryCharacter?.animationName]);
