...
import { X, Play, Radio, Info, ShoppingBag, LifeBuoy, MessageSquare, Trophy, Newspaper, ChevronLeft, ChevronRight, ChevronDown, Settings, User, ExternalLink, Gamepad2, Heart, Check, Twitter, Instagram, Target, Swords, Lock, AlertCircle, Zap, Map, TrendingUp, Calendar, Plus, Layers, Users } from 'lucide-react';
            ...
            >
              ...
              {friendTab === 'games' && (
                ...
                >
                  ...
                  <div className="rounded-2xl border border-white/8 p-5 mb-4" style={{ background: 'rgba(15,22,38,0.75)', backdropFilter: 'blur(20px)' }}>
