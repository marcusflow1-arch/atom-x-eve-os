...
import { Trophy, Camera, BookOpen, Sparkles, ChevronUp, ChevronDown } from 'lucide-react';
...
export default function LibraryAchievementsUniverse() {
    ...
    >
      <div className="flex items-center justify-between px-5 py-3 border-b border-white/5 flex-shrink-0">
        <div>
          ...
          <p className="text-[11px] text-white/35 mt-1">Guides, screenshots, definitions, and a live demo viewer.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[320px_minmax(0,1fr)] gap-5 min-h-full">
          <div className="space-y-4">
            <div className="rounded-2xl border border-white/10 bg-white/5 overflow-hidden">
              <div className="h-[280px] relative bg-black/30">
              ...
              <div className="p-4 border-t border-white/5">
                <p className="text-[10px] uppercase tracking-[0.25em] text-yellow-400/70 mb-2">3D Demo</p>
                <p className="text-sm text-white/70 leading-relaxed">{selectedAchievement.demo}</p>
              </div>
            </div>
          ...
          <div className="space-y-4 min-w-0">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <div className="grid lg:grid-cols-[minmax(0,1fr)_140px] gap-4">
                <div className="rounded-2xl overflow-hidden border border-white/10 bg-black/30 min-h-[280px]">
                  <img
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              <p className="text-[10px] uppercase tracking-[0.25em] text-white/45 mb-3">Scroll Through Achievements</p>
