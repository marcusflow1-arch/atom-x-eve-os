...
export default memo(function AuraLifeStreams({ streams, samples, onWatch }) {
  ...
  return <div className="aura-life-directory">
    ...
    <div className="aura-life-streams">
      <div className="aura-life-toolbar"><span>{visible.length} live channels</span><Link to="/AuraLife"><Maximize2 size={14} />Full screen</Link></div>
