...
export const PUBLIC_FIELDS = {
  ...
  StreamerProfile: ['id', 'user_id', 'display_name', 'bio', 'tagline', 'avatar_url', 'cover_image_url', 'follower_count', 'personality_traits', 'channel_rules', 'schedule_note', 'created_date'],
