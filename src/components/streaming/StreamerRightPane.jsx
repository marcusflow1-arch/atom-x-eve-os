  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-4 flex-col lg:flex-row">
        {/* Stream box (80%) */}
        <div className="flex-[4] border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden">
        ...
        {/* Live chat (20%) */}
        <div className="flex-[1] h-[520px] border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden flex flex-col">
