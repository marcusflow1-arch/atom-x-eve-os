...
import {
  ...
  ChevronRight, Clock, Sparkles, Eye, CheckCircle2
} from 'lucide-react';
...
export default function TradingWorkspace({ item, onClose }) {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 bottom-0 left-80 sm:left-96 right-0 z-[72] flex flex-col overflow-hidden"
      style={{
        background: 'rgba(8, 12, 18, 0.92)',
        backdropFilter: 'blur(50px) saturate(180%)',
        WebkitBackdropFilter: 'blur(50px) saturate(180%)',
        boxShadow: 'inset 0 0 0 1px rgba(165, 243, 252, 0.08)',
