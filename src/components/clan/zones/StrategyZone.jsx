...
export default function StrategyZone({ game }) {
    const plans = [
        ...
        <div className="h-full flex gap-6 p-6">
            ...
            <div className="flex-1 bg-black/40 border border-white/10 rounded-2xl overflow-hidden flex flex-col">
                <div className="h-12 border-b border-white/10 flex items-center px-4 bg-white/5 gap-4">
                    <span className="font-bold text-white/60">Boss Phase 2 Tactics</span>
                ...
                <div className="flex-1 p-8 text-white/70">
