        ...
        <div className="absolute bottom-[130px] left-8 w-[320px] flex flex-col gap-4 pointer-events-auto">
          ...
          <div className="relative w-full z-30" ref={upgradesDropdownRef}>
            <button
              ...
              style={{
                background: upgradesOpen ? 'rgba(34, 211, 238, 0.15)' : 'rgba(34, 211, 238, 0.1)',
                backdropFilter: 'blur(24px)',
                WebkitBackdropFilter: 'blur(24px)',
                border: `1px solid ${upgradesOpen ? 'rgba(34, 211, 238, 0.4)' : 'rgba(34, 211, 238, 0.2)'}`,
                boxShadow: upgradesOpen 
                  ? '0 4px 20px rgba(34, 211, 238, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.1)'
                  : 'inset 0 1px 0 rgba(255, 255, 255, 0.05)'
              }}
            >
              <div className="flex items-center gap-3">
                <Zap className="w-5 h-5 text-cyan-400" />
                <span className="text-white text-base font-bold uppercase tracking-wider" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.6)' }}>
                  Upgrade Stronghold
                </span>
              </div>
                  ...
                  <div className="p-3 max-h-[320px] overflow-y-auto">
                    <div className="grid grid-cols-2 gap-2">
                      <motion.button
                        ...
                        className={`relative w-full aspect-[16/10] rounded-xl overflow-hidden transition-all duration-300 border group text-left ${environmentUrl.includes('ddff') ? 'border-cyan-400 ring-1 ring-cyan-400/50' : 'border-white/[0.06] hover:border-white/20'}`}
                      >
                        ...
                        {environmentUrl.includes('ddff') && (
                          <div className="absolute top-1.5 right-1.5 bg-cyan-500 text-black text-[8px] font-bold px-1.5 py-0.5 rounded-full flex items-center gap-0.5 shadow-sm">
                      ...
                      <motion.button
                        ...
                        className={`relative w-full aspect-[16/10] rounded-xl overflow-hidden transition-all duration-300 border group text-left ${environmentUrl.includes('virtual_room') ? 'border-cyan-400 ring-1 ring-cyan-400/50' : 'border-white/[0.06] hover:border-white/20'}`}
                      >
