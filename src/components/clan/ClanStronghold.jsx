  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 pointer-events-none p-6">
        ...
        <div className="absolute bottom-[80px] right-8 h-[400px] flex pointer-events-auto items-end shadow-2xl rounded-2xl overflow-hidden border border-white/10 bg-black/60 backdrop-blur-xl">
          {/* Roster Extension */}
          <AnimatePresence>
            {isRosterOpen && (
              <motion.div
