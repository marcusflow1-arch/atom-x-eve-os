...
import { Search, Ghost, ArrowUpRight, ArrowDownLeft, ChevronRight, ChevronLeft, Gamepad2, Filter, X } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Badge } from '@/components/ui/badge';
import { itemData, inventoryData } from '../profile/mockData';
    ...
    return (
        <div
            ...
            className={`
                ...
                hover:border-opacity-100 hover:shadow-[0_0_15px_rgba(6,182,212,0.3)]
...
export default function LunaInventory({ onClose, onItemSelect }) {
    ...
    const processedInventory = useMemo(() => {
        return inventoryData.map(item => augmentItem(item));
    }, []);
    ...
    return (
        <div className="w-full max-w-5xl h-[600px] flex overflow-hidden shadow-2xl relative bg-slate-950/90 rounded-xl border border-slate-800">
            ...
            <button 
                onClick={onClose}
                className="absolute top-4 right-4 z-50 p-2 bg-slate-800/50 hover:bg-slate-700 rounded-full text-white transition-colors"
            >
                <X className="w-4 h-4" />
            </button>
            ...
            <div className="flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-slate-900/50 to-black/50 relative z-10">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800/50">
                    ...
                    <div className="w-64 relative mr-8">
