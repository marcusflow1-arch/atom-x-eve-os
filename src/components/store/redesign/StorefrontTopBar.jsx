...
export default function StorefrontTopBar({user,cartCount=0,searchTerm,onSearchChange,games=[],onSelectGame}){
 ...
 return <div className="flex w-full items-center gap-4">
  ...
  <div className="mx-auto w-full max-w-2xl min-w-0"><StoreSearch games={games} value={searchTerm} onChange={onSearchChange} onSelect={onSelectGame}/></div>
