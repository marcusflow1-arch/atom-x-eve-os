...
import { ChevronRight, MapPin, Users, Calendar, TrendingUp, Gamepad2, Lightbulb } from 'lucide-react';
import DevProjectShowcase from './DevProjectShowcase';
import DevUpdatesSlideshow from './DevUpdatesSlideshow';
...
export default function DeveloperShowcaseSection({ dev, onSelect, index }) {
  ...
  return (
    ...
    >
      ...
      {/* ═══════════════ SECTION 2: Interactive In-Development Showcase ═══════════════ */}
      <div className="mb-8">
        <DevProjectShowcase projects={dev.inDevelopment} accent={a} />
      </div>
      ...
      <div className="mb-6">
        ...
        {/* Auto-rotating updates slideshow */}
        <DevUpdatesSlideshow updates={dev.updates} accent={a} />
      </div>
      ...
      {dev.customCards.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3 px-1">
            <ChevronRight className={`w-4 h-4 ${a.text}`} />
