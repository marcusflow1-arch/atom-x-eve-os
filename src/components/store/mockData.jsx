...
export const developerStudioMap = {
  ...
  'ubisoft': { name: 'Ubisoft', type: 'Publisher', parent: null },
  'bungie': { name: 'Bungie', type: 'Developer', parent: null },
  ...
  'avalanche_software': { name: 'Avalanche Software', type: 'Developer', parent: 'Warner Bros' },
  ...
  'electronic_arts': { name: 'Electronic Arts', type: 'Publisher', parent: null },
  'activision_blizzard': { name: 'Activision Blizzard', type: 'Publisher', parent: 'Microsoft' },
  '343_industries': { name: '343 Industries', type: 'Developer', parent: 'Microsoft' },
  'the_coalition': { name: 'The Coalition', type: 'Developer', parent: 'Microsoft' },
  'rare': { name: 'Rare', type: 'Developer', parent: 'Microsoft' },
  'arkane_studios': { name: 'Arkane Studios', type: 'Developer', parent: 'Microsoft/ZeniMax' },
  'platinumgames': { name: 'PlatinumGames', type: 'Developer', parent: null },
  'team_ninja': { name: 'Team Ninja', type: 'Developer', parent: 'Koei Tecmo' },
  'id_software': { name: 'id Software', type: 'Developer', parent: 'Microsoft/ZeniMax' },
  'machinegames': { name: 'MachineGames', type: 'Developer', parent: 'Microsoft/ZeniMax' },
  'avalanche_studios': { name: 'Avalanche Studios', type: 'Developer', parent: null },
  'io_interactive': { name: 'IO Interactive', type: 'Developer', parent: 'Embracer Group' },
  'gearbox_software': { name: 'Gearbox Software', type: 'Developer', parent: 'Embracer Group' },
  'telltale_games': { name: 'Telltale Games', type: 'Developer', parent: null },
  'supergiant_games': { name: 'Supergiant Games', type: 'Developer', parent: null },
  'devolver_digital': { name: 'Devolver Digital', type: 'Publisher', parent: null },
  'double_fine': { name: 'Double Fine Productions', type: 'Developer', parent: 'Microsoft' },
  'playdead': { name: 'Playdead', type: 'Developer', parent: null },
  'housemarque': { name: 'Housemarque', type: 'Developer', parent: 'Sony Interactive' },
  'digital_extremes': { name: 'Digital Extremes', type: 'Developer', parent: null },
  'crytek': { name: 'Crytek', type: 'Developer', parent: null },
  'respawn_entertainment': { name: 'Respawn Entertainment', type: 'Developer', parent: 'Electronic Arts' },
  'remedy_entertainment': { name: 'Remedy Entertainment', type: 'Developer', parent: null },
  'sega': { name: 'SEGA', type: 'Publisher', parent: null },
  'konami': { name: 'Konami', type: 'Publisher', parent: null },
  'bandai_namco': { name: 'Bandai Namco Entertainment', type: 'Publisher', parent: null },
  'square_enix': { name: 'Square Enix', type: 'Publisher', parent: null },
