...
export const AXE_PROMPT_MANIFEST = Object.freeze([
  ...
  { prompt: 11, system: 'Character stats and progression', status: AXE_STATUS.PARTIAL },
  { prompt: 12, system: 'Factions and weapon identities', status: AXE_STATUS.PARTIAL },
  ...
  { prompt: 27, system: 'Wings', status: AXE_STATUS.PARTIAL },
