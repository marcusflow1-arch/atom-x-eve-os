  ...
  return (
    ...
    >
      ...
      <div className="relative h-36 overflow-hidden">
        ...
        {/* Live Badge */}
        <div className="absolute top-3 left-3 flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] font-bold uppercase"
        ...
        {/* Genre Tag */}
        <div className="absolute top-3 right-3 px-2 py-1 rounded-md text-[10px] font-bold uppercase text-white/50 capitalize"
      ...
      <div className="p-4">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-bold text-sm truncate group-hover:text-cyan-300 transition-colors duration-200">
              {game.title}
            </h3>
            <div className="flex items-center gap-3 mt-2">
              ...
              <div className="flex items-center gap-1.5 text-white/30 text-[11px]">
                ...
                {Math.floor(game.activeUsers / 100)} squads
              </div>
            </div>
          </div>
          <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-200 group-hover:bg-white/10"
